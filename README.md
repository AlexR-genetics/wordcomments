...
[![Documentation](https://img.shields.io/badge/docs-pkgdown-blue)](https://alexr-genetics.github.io/wordcomments/)
<!-- badges: end -->
...
| Column | Description |
|--------|-------------|
| Text | The text that was commented on |
| Comment | The comment content |
| Author | Comment author |
| Date | Timestamp |
| Line | Paragraph number (position in document) |
...
- Commented Text
- Reviewer Comment
- Author Response (empty - for you to fill)
- Action Taken (empty - for you to fill)
- Line in Revision (empty - for you to fill)
...
- **Page numbers**: These are estimated (~25 paragraphs per page) since Word calculates pages at render time based on fonts/margins.
- **Resolution status**: The package checks multiple XML files (`commentsExtended.xml`, `commentsExtensible.xml`) to detect resolved comments across different Word versions.
